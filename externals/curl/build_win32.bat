@echo off
REM ====================================================================
REM build_win32.bat -- Build a static libcurl for Windows x86.
REM
REM Run from a "x86 Native Tools Command Prompt for VS 20xx".
...
REM
REM Output:
REM   externals\curl\lib\x86\libcurl_a.lib
REM
REM Usage (from the TH8 root directory):
REM   externals\curl\build_win32.bat
REM   externals\curl\build_win32.bat debug
REM
...
echo.
echo Configuring libcurl x86 %BUILD_TYPE% (static, Schannel, zlib=%ZLIB_FLAG%)...
