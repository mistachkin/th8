...
/* TH8: Forward declarations removed.  They cause link errors at -O0
 * because the linker cannot dead-strip calls to platform-specific
...
{
   mp_err err = MP_ERR;
   /* TH8: Use #ifdef instead of MP_HAS() for -O0 compatibility. */
